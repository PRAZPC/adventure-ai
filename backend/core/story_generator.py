...
class StoryGenerator:
    ...
    def generate_story(cls,db : Session,session_id:str ,theme:str='fantasy') -> Story:
        ...
        prompt = ChatPromptTemplate.from_messages([("system",STORY_PROMPT),("human",f"create story with this theme:{theme}")]).partial(format_instructions=story_parser.get_format_instructions())
    ...
    def _process_story_node(cls,db: Session,story_id:int, node_data :StoryNodeLLM,is_root:bool=False)->StoryNode:
        node = StoryNode(
            ...
            is_WinningEnding = node_data.isWinningEnding,
            options= []
        )
        db.add(node)
        db.flush()
