...
def build_complete_story_tree(db:Session, story :Story) -> completestoryresponse   :
      ...
      node_dict = {}
      for node in nodes:
          node_response = completestoryNodeResponse(id=node.id,content=node.content,is_ending=node.is_ending,is_winning_ending=node.is_WinningEnding,options=node.options)
